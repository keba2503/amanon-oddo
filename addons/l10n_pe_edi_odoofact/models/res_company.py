...
class ResCompany(models.Model):
    ...
    activate_einvoice_ticket = fields.Boolean(
        string="Activate Electronic Ticket",
        help="Enable POS electronic ticket functionality for this company"
    )
    l10n_pe_edi_einvoice_config = fields.Html(
        string="E-Invoice Configuration",
        help="HTML configuration for electronic invoices"
    )
