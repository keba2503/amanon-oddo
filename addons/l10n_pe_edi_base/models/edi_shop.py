...
class EdiShop(models.Model):
    ...
    l10n_pe_edi_ose_url = fields.Char(string="URL", help='Base URL for the electronic invoicing API', tracking=True)
    l10n_pe_edi_ose_token = fields.Char(string="Token",help='Authentication token for the electronic invoicing API'
    , tracking=True)
